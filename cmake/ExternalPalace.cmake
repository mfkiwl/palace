...
list(APPEND PALACE_OPTIONS
  ...
  "-DPALACE_WITH_HIP=${PALACE_WITH_HIP}"
)
if(PALACE_WITH_CUDA AND NOT "${CMAKE_CUDA_ARCHITECTURES}" STREQUAL "")
  list(APPEND PALACE_OPTIONS
    "-DCMAKE_CUDA_ARCHITECTURES=${CMAKE_CUDA_ARCHITECTURES}"
  )
endif()
if(PALACE_WITH_HIP AND NOT "${CMAKE_HIP_ARCHITECTURES}" STREQUAL "")
  list(APPEND PALACE_OPTIONS
